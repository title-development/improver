...
public interface RefundRepository extends JpaRepository<Refund, Long> {
    ...
    Page<AdminRefund> getAll(Long id, String contractorEmail, String customerEmail, Refund.Issue issue,
                             Refund.Option option, Refund.Status status, Pageable pageable);
